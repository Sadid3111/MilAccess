...
class ArchiveDatabasePageState extends State<ArchiveDatabasePage> {
                      ...
                      child: filteredDocuments.isEmpty
                          ? ListView(
                              children: const [
                                Center(
                                  heightFactor:
                                      10, // Adjust to center the message vertically
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildDetailRow('Date', document.createdAt!),
  ...
  void _showDocumentContent(DocumentItem document) {
    showDialog(
      context: context,
